...
#~ adb pull /system/lib/hw/vendor-gps.smdkv310.so ../../../vendor/$MANUFACTURER/$COMMON/proprietary/hw/gps.GT-I9070.so
...
# All the blobs necessary for janice devices
PRODUCT_COPY_FILES += \\
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__MANUFACTURER__/__COMMON__/proprietary/wifi/bcm4330_aps.bin:system/etc/wifi/bcm4330_aps.bin \\
    vendor/__MANUFACTURER__/__COMMON__/proprietary/wifi/bcm4330_mfg.bin:system/etc/wifi/bcm4330_mfg.bin \\
    vendor/__MANUFACTURER__/__COMMON__/proprietary/wifi/bcm4330_sta.bin:system/etc/wifi/bcm4330_sta.bin
